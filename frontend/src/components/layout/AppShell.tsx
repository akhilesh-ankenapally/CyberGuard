  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-cyber-text">
      ...
      <div className="relative mx-auto flex h-screen w-full max-w-[390px] flex-col overflow-hidden rounded-[24px] bg-cyber-bg shadow-[0_14px_24px_rgba(0,0,0,0.06)] backdrop-blur-xl">
        ...
        <header className="relative z-20 grid h-14 shrink-0 grid-cols-3 items-center bg-[linear-gradient(135deg,rgba(238,242,255,0.96),rgba(224,231,255,0.92))] px-4 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
        ...
        <section className="relative z-10 flex-1 overflow-y-auto px-4 pt-14 pb-24">
          <Outlet />
        </section>
